...
import com.example.androidapp.databinding.ItemContainerRecentConversationBinding;
...
public class RecentConversationsAdapter extends RecyclerView.Adapter<RecentConversationsAdapter.ConversationViewHolder> {
    ...
    class ConversationViewHolder extends RecyclerView.ViewHolder {
        ...
        void setData(ChatMessage chatMessage) {
            binding.imgUserAvatar.setImageBitmap(getConversationImage(chatMessage.conversationImage));
            binding.textName.setText(chatMessage.conversationName);
            binding.textRecentMessage.setText(chatMessage.message);
            binding.getRoot().setOnClickListener(v -> {
                User user = new User();
                user.id = chatMessage.conversationId;
                user.nameDisplay = chatMessage.conversationName;
